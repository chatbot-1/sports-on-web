        ...
        <div className="terms-box">
          ...
          <div className="terms-content">
            <p>
              ...
              corrupti, neque reprehenderit tempore quis soluta autem sequi sunt
              provident architecto vel maxime atque sapiente doloremque nesciunt
              inventore in magni fugiat. Atque!
            </p>
            <p>
            ...
            <p>
              ...
              qui id aliquam harum? Repudiandae exercitationem fuga officia ex
              laudantium illum illo ea impedit beatae vel laborum itaque,
              corporis saepe, quas eveniet harum quia qui et omnis eum
            ...
            <p>
              ...
              praesentium magnam numquam vel debitis tempora excepturi maxime
              officiis inventore aperiam facilis non eligendi rerum ipsam iste,
              aspernatur quis laudantium eaque, molestias, ex aliquid? Eveniet
              necessitatibus impedit obcaecati cumque sunt voluptatem dolore
              ipsa quaerat esse voluptates deleniti, eius quisquam saepe harum,
              et tenetur hic doloremque! Sequi, optio quasi? Fugiat ipsum
              voluptas nobis consequatur quo vero ea error eligendi! Quasi,
              voluptates soluta voluptatum sit ad repellat asperiores delectus.
              Illum et at nostrum.
            </p>
            <p>
              ...
              Veritatis consectetur deleniti eos minus distinctio at nihil odio
              delectus.
            </p>
            <p>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas
              cupiditate laudantium, voluptatum nostrum accusamus molestiae ipsa
              vero non dolore eum explicabo reiciendis ut!
            </p>
          </div>
          <div className="terms-button">
            <button className="terms-btn1">Decline</button>
            <button className="terms-btn2" onClick={takeToHome}>Accept</button>
          </div>
        </div>
      </div>
    </div>
